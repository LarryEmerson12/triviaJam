<template>
  <div>
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          this Agreement) refers to TriviaJam.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to TriviaJam, accessible from
          <a
            href="https://www.triviajam.netlify.app"
            rel="external nofollow noopener"
            target="_blank"
            >https://www.triviajam.netlify.app</a
          >
        </p>
      </li>
      <li>
    ...
    <ul>
      <li>By email: larry.emerson14@gmail.com</li>
    </ul>
  </div>
</template>
